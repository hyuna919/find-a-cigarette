/*
  ...
  1) .env파일이 이 파일을 /src에 위치...
  2) package.json에 "type": "module", 추가
  3) src위치에서 node 파일명.js 명령 입력
  4) Firestore 보안규칙 열어놔야. >> 추후엔 cloud function쓰는 방법으로 수정해야할지도.
...
dotenv.config();
const jsonFile = fs.readFileSync("./assets/cigaretteList.json", "utf8");
